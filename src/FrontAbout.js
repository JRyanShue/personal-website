    ...
    return (
        <div>
            <div className="front-about" style={{width: textWidth}}>
                ...
                I'm currently working with collaborators on an AI research project applying transformers to single-shot 3D neural field generation. The goal is to build a model that will map a 3D shape into a neural field parameterizing it. Neural fields already have many applications, but I'm most excited about the promise they hold as more perfect representations of data, and what this means for AI as a whole. 
                <br/><br/>
                ...
                and co-founded the creation of a stackable hydroponic system (called "<a href="https://www.kickstarter.com/projects/thecanopy/the-canopy-smart-vertical-farm" style={{color:'rgb(214, 214, 214)'}}>The Canopy</a>"), which we successfully funded on Kickstarter and are currently working on producing. I've previously also had the opportunity to work at <></>
